# Explaning rbinom()
# rbinom(n, size, probe) generate random numbers from a binomial distribution
# Here:
# n = Number of random values to generate
# size = Number of trials in each binomial experiment
# probe = probability of success in each trial
...
# The result means theres about a 62.3% chances of getting 5 or fewer successes
...
pbinom(q = 3, siz = 5, prob = 0.5) - pbinom(q = 2, siz = 5, prob = 0.5)

# Explaining qbinom() 
# What is the smallest no of successes x in 10 trials
...
# Explaining dbinom()
# calculating the probability of getting exact no of success
# you toss a coin 5 times. what is the probability of getting exactly 3 heads?
...
# dbinom(x, size, prob)
# x = 3 --> no of successes you want
# size = 5 --> no of independent trials
